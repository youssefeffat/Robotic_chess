...
class GameEngine(IGameEngine):
    ...
    def create_interface(self) -> str:
        return self.user_interface.create_game(self.camera.get_fen())
    ...
    def apply_human_move(self):
        new_fen = self.camera.get_fen()
        move = self.get_move_between_fens(self.game.get_fen(), new_fen)
        self.game.set_fen(new_fen)
